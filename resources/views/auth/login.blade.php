    ...
    <div class="max-w-md w-full space-y-8">
        ...
        <div class="text-center" data-aos="fade-down">
            <h2 class="text-4xl font-extrabold text-gray-900 dark:text-white">
                <i class="fas fa-laptop-medical text-neon-light mr-2"></i>HelpIT ID
            </h2>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 neon-border hover:neon-glow transition-all" data-aos="fade-up">
                ...
                <div class="flex items-center justify-between">
                    ...
                    <div class="text-sm">
                        <a href="{{ route('password.request') }}" 
                           class="font-medium text-primary hover:text-primary/80 dark:text-primary/80">
                            Lupa password?
                        </a>
                    </div>
                    @endif
            ...
            <!-- Demo Accounts Info -->
            <div class="mt-6 p-4 bg-gradient-to-r from-primary/10 to-secondary/10 dark:from-primary/20 dark:to-secondary/20 rounded-lg neon-border">
                <h4 class="text-sm font-medium text-primary dark:text-primary/80 mb-2">
                    <i class="fas fa-info-circle mr-1"></i>Akun Demo
                </h4>
                <div class="text-xs text-primary/80 dark:text-primary/60 space-y-1">
                    <p><span class="font-semibold">Admin:</span> admin@helpit.id / admin123</p>
