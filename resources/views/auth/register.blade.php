...
@section('title', 'Daftar - HelpIT ID')
    ...
    <div class="max-w-md w-full space-y-8">
        ...
        <div class="text-center" data-aos="fade-down">
            <h2 class="text-4xl font-extrabold text-gray-900 dark:text-white">
                <i class="fas fa-user-plus text-neon-light mr-2"></i>Buat Akun Baru
            </h2>
            <p class="mt-2 text-sm text-gray-600 dark:text-gray-400">
                Bergabung dengan HelpIT ID untuk solusi IT terbaik
            </p>
        </div>

        <!-- Register Card -->
        <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 neon-border hover:neon-glow transition-all" data-aos="fade-up">
            <form method="POST" action="{{ route('register') }}" class="space-y-6">
                    ...
                    <div class="relative">
                        <input id="name" type="text" name="name" value="{{ old('name') }}" 
                               ...
                               class="w-full px-4 py-3 pl-10 border border-gray-300 dark:border-gray-600 
                                      ...
                                      @error('name') border-red-500 @enderror neon-border focus:neon-glow"
                    ...
                    <div class="relative">
                        <input id="email" type="email" name="email" value="{{ old('email') }}" 
                               ...
                               class="w-full px-4 py-3 pl-10 border border-gray-300 dark:border-gray-600 
                                      rounded-lg focus:ring-2 focus:ring-primary focus:border-primary 
                                      bg-white dark:bg-gray-700 text-gray-900 dark:text-white 
                                      @error('email') border-red-500 @enderror neon-border focus:neon-glow"
                    ...
                    <div class="relative">
                        <input id="password" type="password" name="password" 
                               ...
                               class="w-full px-4 py-3 pl-10 pr-10 border border-gray-300 dark:border-gray-600 
                                      rounded-lg focus:ring-2 focus:ring-primary focus:border-primary 
                                      bg-white dark:bg-gray-700 text-gray-900 dark:text-white 
                                      @error('password') border-red-500 @enderror neon-border focus:neon-glow"
                ...
                <div>
                    ...
                    <div class="relative">
                        <input id="password-confirm" type="password" name="password_confirmation" 
                               ...
                               class="w-full px-4 py-3 pl-10 border border-gray-300 dark:border-gray-600 
                                      rounded-lg focus:ring-2 focus:ring-primary focus:border-primary 
                                      bg-white dark:bg-gray-700 text-gray-900 dark:text-white neon-border focus:neon-glow"
                ...
                <div class="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg neon-border">
                    <h4 class="text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                        <i class="fas fa-shield-alt mr-1 text-primary"></i>Persyaratan Password
                    </h4>
                ...
                <div class="flex items-start">
                    ...
                    <div class="ml-3 text-sm">
                        <label for="terms" class="text-gray-700 dark:text-gray-300">
                            Saya menyetujui 
                            <a href="{{ route('terms') }}" class="text-primary hover:text-primary/80">
                                Syarat & Ketentuan
                            </a> 
                            dan 
                            <a href="{{ route('privacy') }}" class="text-primary hover:text-primary/80">
                                Kebijakan Privasi
                            </a>
                        </label>
                    </div>
                ...
                <div>
                    <button type="submit" 
                            class="w-full flex justify-center items-center py-3 px-4 border border-transparent 
                                   ...
                                   from-primary to-secondary hover:shadow-xl hover:shadow-primary/30
                                   focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary 
                                   transition duration-300 transform hover:-translate-y-0.5 neon-glow">
            ...
            <div class="mt-6 text-center">
                <a href="{{ route('login') }}" 
                   class="inline-flex items-center px-4 py-2 border border-primary text-primary 
                          dark:text-primary rounded-lg hover:bg-primary/10 dark:hover:bg-primary/20 
                          transition duration-300 neon-border hover:neon-glow">
                    <i class="fas fa-sign-in-alt mr-2"></i>Masuk ke akun yang sudah ada
                </a>
            </div>

            <!-- Benefits Info -->
            <div class="mt-6 p-4 bg-green-50 dark:bg-green-900/20 rounded-lg neon-border">
