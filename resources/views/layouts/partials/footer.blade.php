<footer class="relative bg-background text-text/70 py-20 overflow-hidden">
    <div class="absolute top-0 right-0 w-96 h-96 bg-primary/10 blur-[100px] rounded-full translate-x-1/2 -translate-y-1/2"></div>
    ...
    <div class="max-w-7xl mx-auto px-6 relative z-10">
        <div class="grid grid-cols-1 md:grid-cols-12 gap-12">
            ...
            <div class="md:col-span-5">
                <a href="{{ route('home') }}" class="inline-flex items-center gap-2 mb-6 group">
                    ...
                    <span class="text-2xl font-black text-white tracking-tighter">HelpIT<span class="text-primary">.ID</span></span>
                </a>
                ...
                <div class="flex gap-4">
                    <a href="#" class="w-10 h-10 rounded-full bg-surface flex items-center justify-center hover:bg-primary hover:text-white transition shadow-xl border border-surface">
            ...
            <div class="md:col-span-3">
                ...
                <form class="relative group">
                    <input type="email" placeholder="Email Anda" 
                           class="w-full bg-surface border border-surface rounded-xl px-4 py-3 text-sm focus:ring-2 focus:ring-primary focus:border-transparent transition outline-none text-text">
                    <button class="absolute right-2 top-2 p-1.5 bg-primary text-white rounded-lg hover:bg-primary/80 transition">
        ...
        <div class="mt-20 pt-8 border-t border-surface flex flex-col md:flex-row justify-between items-center gap-4">
            <p class="text-xs font-bold">
                &copy; {{ date('Y') }} HelpIT ID. Crafted with <i class="fas fa-heart text-accent animate-pulse"></i> by HelpIT Team.
            </p>
